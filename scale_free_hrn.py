...
def find_k(int_cond , t, A , a , b , c , d , g , I, n , adj_sum , k , lim , delta_k) :
    event_counter = 0
    with parallel_config(n_jobs=5 , backend="loky"):
        with Parallel() as parallel:
            print(f"Inner pool actual jobs : {parallel.n_jobs}")
    ...
    if delta_k < 0.0001 :
        ...
        return 0
def final_parallel(t, a , b , c , d , g , I , k , p) :
    ...
    if p == 0.1 :
        coupling_threshold = find_k(int_cond , t, A , a , b , c , d , g , I , n , adj_sum , k=8 , lim = 14 , delta_k = 0.05)
    elif p == 0.2 :
        coupling_threshold = find_k(int_cond , t, A , a , b , c , d , g , I , n , adj_sum , k=4 , lim = 11 , delta_k = 0.05)
    elif p == 0.3 :
        coupling_threshold = find_k(int_cond , t, A , a , b , c , d , g , I , n , adj_sum , k=1.5 , lim = 6 , delta_k = 0.0)
    else :
        coupling_threshold = find_k(int_cond , t, A , a , b , c , d , g , I , n , adj_sum , k=1 , lim = 5 , delta_k = 0.05)
...
def parallel_for(t, a , b , c , d , g , I , k , edge_densities) :
    list = Parallel(n_jobs=8)(delayed(final_parallel)(t, a , b , c , d , g , I , k , p) for p in edge_densities)
    coupling_thresholds = []
    edge_density = []
    ...
    for i in list:
        ...
        df.to_csv("scale_free_hrn.csv" ,index= False)
    return df
def main():
    edge_densities = np.linspace(0.1 , 0.8, 8)
    parallel_for(t, a , b , c , d , g , I , k , edge_densities)
