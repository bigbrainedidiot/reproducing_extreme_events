...
def final_parallel(t, a , b , c ,d ,g, I , p) :
    ...
    if p ==0.1 :
        ...
        coupling_threshold = find_k(int_cond , t, A , a , b , c , d , g , I, n , adj_sum , k=1 , lim = 4 , delta_k = 0.05)
    elif p == 0.5 :
        coupling_threshold = find_k(int_cond , t, A , a , b , c , d , g , I, n , adj_sum , k=0.1 , lim = 3 , delta_k = 0.05)
    else:
        coupling_threshold = find_k(int_cond , t, A , a , b , c , d , g , I, n , adj_sum , k=0.1 , lim = 2 , delta_k = 0.05)
...
def parallel_for(t, a , b , c , d, g, I , edge_densities) :
    ...
    for i in list:
        ...
        df.to_csv("Random_hrn.csv" ,index= False)
    return df
def main():
